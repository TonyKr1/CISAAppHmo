<?php
    ...
    $cursoCiertoFalso = json_decode($_POST['CAP_RespuestasMultiple']);
    ...
    //     //sqlsrv_free_stmt($stmt_Insert_datos);
        foreach($cursoCiertoFalso as $objCurso){
            ...
            $parametros = array(
                ...
                array($objCurso->Justificacion),
                array($objCurso->fecha)
            );

            $C_Insert_check = "INSERT INTO CAP_RespuestasMultiple(FK_CursosHeader, FK_DatosGenerales, FK_IDCurso, FK_IDPregunta, Respuesta, Justificacion, fecha) 
            VALUES (?, ?, ?, ?, ?, ?, ?);";
