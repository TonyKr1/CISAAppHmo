<?php
    ...
    $cursoCiertoFalso = json_decode($_POST['cursoCiertoFalso']);
    ...
    foreach($cedulageneral as $objResS){
        ...
        // }else{
            ...
            $parametros = '';
            $parametros=array(
                array($objResS->geolocalizacion_salida),
                array($objResS->geolocalizacion_entrada),
            ...
            $FKIDCurso = $objResS->geolocalizacion_entrada;
            $FKTipoCurso = $objResS->geolocalizacion_salida;
            $FlagNameCurso = $objResS->nombre_evalua;
        // }
    }
    ...
    //     //sqlsrv_free_stmt($stmt_Insert_datos);
        ...
        foreach($cursoCiertoFalso as $objCurso){
            ...
            $parametros = array(
                ...
                array($objCurso->IDCurso),
                array($objCurso->IDPregunta),
                array($objCurso->Respuesta),
                array($objCurso->fecha)
            );

            $C_Insert_check = "INSERT INTO CAP_RespuestasCiertoFalso(FK_CursosHeader, FK_DatosGenerales, FK_IDCurso, FK_IDPregunta, Respuesta, fecha) 
            VALUES (?, ?, ?, ?, ?, ?);";
